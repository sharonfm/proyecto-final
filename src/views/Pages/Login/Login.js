                ...
                <CardBody>
                  <Form>
                    ...
                    <InputGroup className="mb-3">
                      ...
                      <Input type="text" placeholder="Username" autoComplete="username" name = "userEmail" value = {email} onChange = {(event) => onChangeHandler(event)} />
                    </InputGroup>
                    <InputGroup className="mb-4">
                      ...
                      <Input type="password" placeholder="Password" autoComplete="current-password" name = "userPassword" value = {password} onChange = {(event) => onChangeHandler(event)} />
                    </InputGroup>
                    <Row style={{ justifyContent: 'center' }}>
                      <Link to="/base/info">
                        <Col xs="6" >
                          <Button className="px-4" onClick = {(event) => {signInWithEmailAndPasswordHandler(event, email, password)}} tabIndex={-1} style={{ backgroundColor: '#43425D' }}> <medium style={{ color: '#F2F2F2' }}>Ingresar</medium> </Button>
                        </Col>
                      </Link>
