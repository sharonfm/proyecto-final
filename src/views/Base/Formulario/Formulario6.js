            ...
            <Card>
              ...
              <CardBody>
                <Form action="" method="post" encType="multipart/form-data" className="form-horizontal">
                  ...
                  <Pagination>
                    <Link to="/base/form5">
                      <PaginationItem><PaginationLink tag="button">Prev</PaginationLink></PaginationItem>
                    </Link> 
                    <Link to="/base/form">
                    ...
                    <PaginationItem active><PaginationLink tag="button">6</PaginationLink></PaginationItem>
                    
                    
                    <PaginationItem disabled><PaginationLink tag="button">Next</PaginationLink></PaginationItem>
