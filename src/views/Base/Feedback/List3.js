...
const List3 = () => {
  ...
  const [answerslist3] = useState([options0, options1, options2, options3, options4/* , options5, options6, options7, options8, options9, options10, options11 */])
            ...
            <CardBody>
              ...
              {/* <Row>
                  ...
                  <Col xs="12" md="8">
                    <TabContent activeTab={activeTab}>
                      <TabPane tabId={8}>
                        <p>Para este tipo de dominio(BAI) en cuanto a los objetivos de gestión y teniendo en cuenta la calificación
